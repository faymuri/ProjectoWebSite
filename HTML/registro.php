        ...
        <form class="formulario">
            ...
            <div class="contenedor">
                ...
                <div class="input-contenedor">
                    ...
                    <input type="password" placeholder="Contraseña" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="debe contener 8 o más caracteres que tengan al menos un número y una letra mayúscula y minúscula:" required>

                </div>
                <input type="submit" value="Registrate" onclick="getDataRegistro()" class="button">
                <p>Al registrarte, aceptas nuestras Condiciones de uso y Política de privacidad.</p>
                <p>¿Ya tienes una cuenta?<a class="link" href="/HTML/login.html">Iniciar Sesion</a></p>
            </div>
        </form>
            ...
            <article class="columns">
                ...
                <div class="column">
                    ...
                    <iframe
                        ...
                        width="300" height="100" frameborder="0" style="border:0;" allowfullscreen=""

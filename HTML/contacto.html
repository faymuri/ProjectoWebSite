                        ...
                        <form id="contactForm" name="sentMessage" novalidate="novalidate">
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <input class="form-control" name="name" id="name" type="text" placeholder="Nombre completo" required="required" data-validation-required-message="Por favor ingrese su nombre." />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <input class="form-control" id="email" type="email" placeholder="Ingrese correo electronico" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Ingrese un correo electronico valido"  required="required" data-validation-required-message="Por favor ingrese su direccion de correo electronico." />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <input class="form-control" id="phone" type="tel" placeholder="Ingresa tu numero telefonico" pattern="[0-9].{7,}" required="required" title="Por favor ingresa tu numero telefonico valido" data-validation-required-message="Por favor ingresa tu numero telefonico." />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                   <textarea class="form-control" id="message" rows="5" placeholder="Ingresa un mensaje con tu solicitud detalada o tu inconveniente." required="required" data-validation-required-message="Por favor ingresa un mensaje." ></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br />
                            <div id="success"></div>
                            <div class="form-group"><input type="submit" onclick="getDataContacto()" value="Enviar mensaje" class="button"></div>
                        </form>
                    </div>
                </div>
            </div>

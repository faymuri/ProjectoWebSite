            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <h5>930.000</h5>
                        <p class="card-text">El procesador AMD Ryzen 5 3600 Wraith Spire (3,6 GHz / 4,2 GHz) es uno de
                            los
                            primeros procesadores para PC grabados en 7 nm. Sus 6 núcleos y 12 hilos, una frecuencia de
                            hasta 4,2
                            GHz y 35 MB de GameCache lo hacen versátil, te permite hacer todo de forma rápida y sin
                            problemas.</p>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <h5>$467,000</h5>
                        <p class="card-text">Placa madre Intel B365 Ultra Durable con GIGABYTE 8118 Gaming LAN, PCIe
                            Gen3 x4

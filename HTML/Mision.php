    ...
    <div class="contenedorx">
      <div class="col-12 user-img">
        ...
        <div class="parrafo">
          ...
          <br>
          <br>
          <p>Nuestra mision es seguir brindando piezas de calidad para ser más reconocidos o tener mas clientes asi podemos brindar el mayor valor posible y que estos obtengan la mejor calidad en nuestros productos</p>
          <br>

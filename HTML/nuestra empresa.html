...
<body>
    ...
    <div class="parrafo">
      ...
      <br>
      <br>
      <p>Somos una empresa dedicada a la venta de hardware y componentes de computador para desktop y laptop de primerisima calidad</p>
      <br>
      <p>Tenemos un amplio portafolio de productos los cuales puedes brindar soluciones a tu hogar y negocio, con mas de 6 años en la industria y mas de 1000 clientes atentidos en nuestras sedes aportamos un gran valor a la ciudad como una de las empresas dedicadas a la venta retail mas populares y que mas valor aporta a la ciudad</p>

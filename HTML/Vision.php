    ...
    <div class="contenedorx">
      <div class="col-12 user-img">
        ...
        <div class="parrafo">
          ...
          <br>
          <br>
          <p>Nuestra vision es poder convertirnos en la tienda lider en la region y asi poder expandir ese negocio hacia otros países volver ese negocio reconocido </p>
          <br>
